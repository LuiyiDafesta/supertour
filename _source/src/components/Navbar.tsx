          ...
          <div className="hidden md:flex items-center gap-8">
            <Link
              ...
              className={`text-sm font-medium tracking-wide uppercase transition-colors duration-200 ${
                isActive('/') ? 'text-primary font-bold glow-text-yellow' : 'text-zinc-300 hover:text-white'
              }`}
            >
              Inicio
            </Link>
            <a
              ...
              className="text-sm font-medium tracking-wide uppercase text-zinc-300 hover:text-white transition-colors duration-200"
            >
              Destinos
            </a>
            {isAdmin ? (
              <>
                <Link
                  to="/admin"
                  className={`flex items-center gap-1.5 text-sm font-medium tracking-wide uppercase transition-colors duration-200 ${
                    isActive('/admin') ? 'text-primary font-bold glow-text-yellow' : 'text-zinc-300 hover:text-white'
                  }`}
                >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-sm font-medium tracking-wide uppercase text-red-400 hover:text-red-300 transition-colors duration-200"
                >
                  <LogOut size={16} />
                  Salir
                </button>
